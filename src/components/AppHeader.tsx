    ...
    <header className={`sticky top-0 z-50 backdrop-blur-xl border-b transition-all duration-500 ${tv(isDark, 'bg-white/95 border-gray-200/50 shadow-lg', 'bg-zinc-900/95 border-zinc-700/50 shadow-2xl')}`}>
      ...
      <div className="relative mx-auto max-w-7xl px-2 sm:px-4 lg:px-8">
        <div className="flex h-14 sm:h-16 items-center justify-between">
          {/* Logo mejorado - Optimizado para móvil */}
          <div className="flex items-center group cursor-pointer" onClick={() => setView('home')}>
            <div className="relative">
              ...
              <Logo className="relative h-6 w-6 sm:h-8 sm:w-8 drop-shadow-lg" />
            </div>
            <div className="ml-2 sm:ml-3">
              ...
              <div className={`text-xs font-medium hidden sm:block ${tv(isDark, 'text-gray-500', 'text-gray-400')} group-hover:text-gray-600 dark:group-hover:text-gray-300 transition-colors duration-300`}>
                Premium Streaming
              </div>
            </div>
          </div>
