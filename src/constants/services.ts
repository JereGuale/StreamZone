...
export const SERVICES = [
  ...
  { id: "disney_standard", name: "Disney+ Standard", price: 3.50, billing: "monthly", color: "bg-blue-500", logo: "D+" },
  ...
  { id: "youtube_premium", name: "YouTube Premium", price: 3.50, billing: "monthly", color: "bg-red-700", logo: "YT" },
  ...
  { id: "spotify", name: "Spotify", price: 3.75, billing: "monthly", color: "bg-emerald-600", logo: "SP" },
